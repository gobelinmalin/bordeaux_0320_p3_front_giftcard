...
const MemberContainer = ({ match, register, isAuthenticated}) => {
    ...
    const handleOnSubmit = (e) => {
        e.preventDefault();
        const client = {civility, lastname, firstname, address, zipcode, city, country, phone, birthdate, createProfile, email, password};
        register(client);
    };
    ...
    return (
        <div className='connexion'>
            ...
            :
            <>
                <form className={`${classes.root} member`} noValidate autoComplete="off">
                    ...
                    <div className='memberform'>
                        ...
                        <TextField
                            ...
                            autoComplete="current-password"
                            style={{ width: 300 }}
                            helperText={passwordConfirm.length > 0 ? 
                                <>{password === passwordConfirm ? 
                                    <div className='confirmpassword'><i class="fas fa-check" /><p>Mot de passe valide</p></div>
                                    : 
                                    <div className='confirmpassword'><i class="fas fa-times" /><p>Le mot de passe n'est pas valide</p></div>
                                }</>
                                : 
...
export default connect(mapStateToProps, {register, clearErrors})(MemberContainer);