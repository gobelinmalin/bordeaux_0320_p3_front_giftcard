...
const Connexion = ({match, login, loginShop, isAuthenticated}) => {
    ...
    return (
        <div className='connexion'>
            <h2>CONNEXION</h2>
            {isAuthenticated? <Redirect to={`/mon-compte-${user}`} email={email} password={password}/> 
            :
...
export default connect(mapStateToProps, {login, loginShop, clearErrors})(Connexion);