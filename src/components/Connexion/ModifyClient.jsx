...
const ModifyClient = ({updateUser, login, client, history, match}) => {
    ...
    const handleOnSubmit = (e) => {
        e.preventDefault();
        const clientNewInfo = {civility, lastname, firstname, address, zipcode, city, country, phone, birthdate, createProfile, email, password};
        updateUser(id, clientNewInfo);
        const identity = { email, password };
        login(identity);
        history.push(`/connexion/${user}`)
    };
    ...
    return (
        <div className='modifycontainer'>
            ...
            {client ?
                <>
                    <form className={`{classes.textField} modifyform`} noValidate autoComplete="off">
                    ...
                    <div className='buttons-modify'>
                        <Button variant="contained" color="primary" className={classes.ButtonConfirm} onClick={() => history.goBack()}>Retour</Button>
                        <Button variant="contained" color="primary" className={classes.ButtonConfirm} onClick={(e) => handleOnSubmit(e)}>Confirmer</Button>
                    </div>
                </>
                : ''}
        </div>
...
export default connect(mapStateToProps, {updateUser, login})(withRouter(ModifyClient));